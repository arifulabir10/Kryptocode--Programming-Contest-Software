...
<body>
    ...
    <div class="main">
        ...
        <form method=get action="resource_content_result.php">
            ...
            <div class="post_title">
                <input type="text" rows="2" id="name" name="resource_name" required>
                <label>Name</label>
<!--                 
            ...
            <div class="certify_admin">
                <input type="textarea" id="des" rows="8" name="resource_link" required></input>
                <label>Link</label>
<!--                 
